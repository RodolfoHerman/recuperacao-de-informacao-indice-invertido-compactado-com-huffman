...
public class ProcessarComPesquisaBinaria {
    ...
    private final String DADOS_COMPARACOESORIG = "./Controle/TermosComparacoesOrigBin.txt";
    private final String DADOS_COMPARACOESCOMP = "./Controle/TermosComparacoesCompBin.txt";

    private File vocabularyFile;
    private ArrayList<String> vocabulario;

    public ProcessarComPesquisaBinaria(ArrayList<String> vocabulario) {
    ...
    public void avaliarComparacoesOrig() throws IOException {
        ...
        for (String string : vocabulario) {
            ...
            test = Pesquisas.pesquisaBinaria(vocabularyOirg, string);
    ...
    public void avaliarComparacoesComp() throws IOException {
        ...
        for (String string : vocabulario) {
            ...
            comp.compac();
            test = Pesquisas.pesquisaBinaria(vocabularyComp, comp.getTermoC());
